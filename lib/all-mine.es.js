...
var AmIcon = /* @__PURE__ */ _export_sfc(_sfc_main$t, [["__scopeId", "data-v-25ad101c"]]);
var clickanime = {
  mounted(el, binding) {
    setTimeout(() => {
...
const _hoisted_2$e = ["placeholder", "value", "onKeyup"];
...
const _hoisted_2$d = { style: { "display": "none" } };
...
const _sfc_main$m = {
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      const _component_AmDropdown = resolveComponent("AmDropdown");
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["am-select", unref(asClass)])
      }, [
        createVNode(_component_AmDropdown, {
          scene: __props.scene,
          "popover-box-class": "am-select__popover"
        }, {
          trigger: withCtx(() => [
            !unref(selectedItem) ? (openBlock(), createElementBlock("p", _hoisted_1$k, toDisplayString(__props.placeholder), 1)) : createCommentVNode("", true),
            _ctx.$slots.selected ? renderSlot(_ctx.$slots, "selected", {
              key: 1,
              selectedItem: unref(selectedItem)
            }) : (openBlock(), createElementBlock("div", _hoisted_2$b, toDisplayString(unref(selectedItem) ? unref(selectedItem).label : ""), 1))
          ]),
          default: withCtx(() => [
            renderSlot(_ctx.$slots, "default")
          ]),
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        __props.content ? (openBlock(), createElementBlock("span", _hoisted_1$h, toDisplayString(__props.content), 1)) : __props.icon ? (openBlock(), createBlock(_component_AmIcon, {
          ...
          name: __props.icon,
          size: __props.size
        }, null, 8, ["name", "size"])) : __props.showLine ? (openBlock(), createElementBlock("i", _hoisted_2$a)) : createCommentVNode("", true)
      ], 4);
    };
  }
};
          ...
          default: withCtx(() => [
            withDirectives(createElementVNode("div", {
              ...
              withDirectives((openBlock(), createElementBlock("div", _hoisted_1$g, [
                _ctx.$slots.hd || __props.title ? (openBlock(), createElementBlock("div", _hoisted_2$9, [
                  __props.title ? (openBlock(), createElementBlock("div", _hoisted_3$7, toDisplayString(__props.title), 1)) : createCommentVNode("", true),
                  renderSlot(_ctx.$slots, "hd"),
                  __props.showCloseBtn ? (openBlock(), createBlock(_sfc_main$s, {
                    key: 1,
                    mode: "text",
                    icon: "close",
                    "icon-size": "16px",
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        __props.type === "line" ? (openBlock(), createElementBlock("div", _hoisted_2$8, [
          createElementVNode("div", {
            ...
            createElementVNode("div", {
              ...
              (__props.showText || _ctx.$slots.default) && __props.textInside ? (openBlock(), createElementBlock("div", _hoisted_3$6, [
...
const _hoisted_2$7 = { class: "am-checkbox__box" };
const _hoisted_3$5 = {
  key: 0,
...
var AmMenu = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["render", _sfc_render$1]]);
var index_vue_vue_type_style_index_0_lang$d = "";
const _hoisted_1$c = { class: "am-menu-item" };
const _hoisted_2$6 = { class: "am-menu-item__text" };
const _hoisted_3$4 = {
  key: 1,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$c, [
        ...
        _ctx.$slots.children ? withDirectives((openBlock(), createElementBlock("div", _hoisted_3$4, [
          ...
          return openBlock(), createBlock(_component_AmButton, {
            ...
            default: withCtx(() => [
              item == "prev" || item === "next" ? (openBlock(), createBlock(_component_AmIcon, {
                ...
                name: "ellipsis",
                size: "18px"
              })) : (openBlock(), createElementBlock("span", _hoisted_2$5, toDisplayString(item), 1))
            ]),
            _: 2
          }, 1032, ["class", "onClick"]);
        }), 128)),
...
const _hoisted_2$4 = { class: "am-logo__main" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$a, [
        createElementVNode("div", _hoisted_2$4, [
          __props.url ? (openBlock(), createElementBlock("img", {
            key: 0,
            src: __props.url
          }, null, 8, _hoisted_3$3)) : (openBlock(), createElementBlock("span", _hoisted_4$1, toDisplayString(__props.name), 1))
        ]),
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$7, [
        createElementVNode("div", {
          ...
          __props.url ? (openBlock(), createElementBlock("img", {
            key: 0,
            src: __props.url
          }, null, 8, _hoisted_2$3)) : (openBlock(), createBlock(AmIcon, {
            key: 1,
            name: "account-fill",
            size: "18px"
          }))
        ], 2),
        __props.name ? (openBlock(), createElementBlock("div", _hoisted_3$2, toDisplayString(__props.name), 1)) : createCommentVNode("", true)
      ]);
    };
  }
};
...
var AmList = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render]]);
...
const _hoisted_1$5 = { class: "am-dropdown__trigger-icon" };
const _sfc_main$5 = {
  props: {
    triggerMode: {
      type: String,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createVNode(_sfc_main$i, {
          ...
          ft: withCtx(() => [
            createVNode(_sfc_main$s, { onClick: clickCancelBtn }, {
              default: withCtx(() => [
...
var index = {
  install(app) {
    ...
    app.component("AmTab", _sfc_main$n);
    app.component("AmButton", _sfc_main$s);
    app.component("AmInput", _sfc_main$r);
    app.component("AmTable", _sfc_main$q);
    app.component("AmTableColumn", _sfc_main$p);
    app.component("AmPopover", _sfc_main$o);
    app.component("AmSelect", _sfc_main$m);
    app.component("AmOption", _sfc_main$l);
    app.component("AmTooltip", _sfc_main$k);
    app.component("AmDivider", _sfc_main$j);
    app.component("AmPopup", _sfc_main$i);
    app.component("AmProgress", _sfc_main$h);
    app.component("AmCheckbox", _sfc_main$g);
    app.component("AmMenu", AmMenu);
    app.component("AmMenuItem", _sfc_main$e);
    app.component("AmPagination", _sfc_main$d);
    app.component("AmLogo", _sfc_main$c);
    app.component("AmForm", _sfc_main$b);
    app.component("AmFormItem", _sfc_main$a);
    app.component("AmAvatar", _sfc_main$9);
    app.component("AmList", AmList);
    app.component("AmListItem", _sfc_main$7);
    app.component("AmWaterfall", _sfc_main$6);
    app.component("AmDropdown", _sfc_main$5);
    app.component("AmSwitch", _sfc_main$4);
    app.component("AmRadio", _sfc_main$3);
  ...
  AmIcon,
  AmButton: _sfc_main$s,
  AmIcon,
  AmButton: _sfc_main$s,
  AmInput: _sfc_main$r,
  AmTable: _sfc_main$q,
  AmTableColumn: _sfc_main$p,
  AmPopover: _sfc_main$o,
  AmTab: _sfc_main$n,
  AmSelect: _sfc_main$m,
  AmOption: _sfc_main$l,
  AmTooltip: _sfc_main$k,
  AmDivider: _sfc_main$j,
  AmPopup: _sfc_main$i,
  AmProgress: _sfc_main$h,
  AmCheckbox: _sfc_main$g,
  AmMenu,
  AmMenuItem: _sfc_main$e,
  AmPagination: _sfc_main$d,
  AmLogo: _sfc_main$c,
  AmForm: _sfc_main$b,
  AmFormItem: _sfc_main$a,
  AmAvatar: _sfc_main$9,
  AmList,
  AmListItem: _sfc_main$7,
  AmWaterfall: _sfc_main$6,
  AmDropdown: _sfc_main$5,
  AmMessage,
  AmLoading,
  AmDialog,
  AmSwitch: _sfc_main$4,
  AmRadio: _sfc_main$3
};
