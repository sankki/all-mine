import { computed, toRefs, openBlock, createElementBlock, normalizeStyle, unref, createElementVNode, withDirectives, normalizeClass, createBlock, createCommentVNode, Fragment, createTextVNode, toDisplayString, renderSlot, ref, onMounted, nextTick, watch, withKeys, provide, defineComponent, h, renderList, getCurrentInstance, inject, onUnmounted, createVNode, Transition, withCtx, vShow, resolveComponent, resolveDirective, reactive, normalizeProps, guardReactiveProps, withModifiers, onBeforeUnmount, render } from "vue";
...
const _hoisted_4$5 = ["readonly", "type", "value", "placeholder", "autocomplete", "onKeyup"];
const _hoisted_5$4 = {
  key: 3,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("label", _hoisted_1$q, [
          ...
          __props.suffix ? (openBlock(), createElementBlock("div", _hoisted_5$4, toDisplayString(__props.suffix), 1)) : createCommentVNode("", true)
        ])
      ], 2);
    };
  }
